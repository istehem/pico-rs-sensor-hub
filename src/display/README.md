When scaling dice pip dimensions to a 265×265 pixel display (approximately 265 pixels per inch), the proportions of a standard American die can be approximated as follows:
